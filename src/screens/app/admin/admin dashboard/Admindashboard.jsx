      ...
      {menu && (
        <div className={`mobilemenu ${menu ? 'open':''}` }  style={{ display:'flex', flexDirection:'column', gap:'20px', position: "fixed", top: "70px", right: "0", width: "230px", height: "calc(100dvh - 70px)", backgroundColor: "#111827", zIndex: "999", padding: "5px 20px", }} >
          ...
          <div  style={{ cursor: "pointer" }} > <IoClose size={35} color="#bfff00"  onClick={()=>{setMenu(false)}}/> </div>
            ...
            <li className="sidebar-btn btn fs-5 px-4 py-2 rounded-3" style={{ backgroundColor: "#111827", border: "1px solid #bfff00", boxShadow: "0 0 12px rgba(191, 255, 0, 0.15)", }} > <NavLink className="sidebar-link text-decoration-none fw-semibold" style={{ color: "#bfff00" }} to="admin-home" onClick={() => setMenu(false)}  > Home </NavLink> </li>
            <li className="sidebar-btn btn fs-5 px-4 py-2 rounded-3" style={{ backgroundColor: "#111827", border: "1px solid #bfff00", boxShadow: "0 0 12px rgba(191, 255, 0, 0.15)", }} > <NavLink className="sidebar-link text-decoration-none fw-semibold" style={{ color: "#bfff00" }} to="admin-member" onClick={() => setMenu(false)} > Members </NavLink></li>
            <li className="sidebar-btn btn fs-5 px-4 py-2 rounded-3" style={{ backgroundColor: "#111827", border: "1px solid #bfff00", boxShadow: "0 0 12px rgba(191, 255, 0, 0.15)", }} > <NavLink className="sidebar-link text-decoration-none fw-semibold" style={{ color: "#bfff00" }} to="admin-store" onClick={()=>{setMenu(false)}} > My store </NavLink> </li>
            <li className="sidebar-btn btn fs-5 px-4 py-2 rounded-3" style={{ backgroundColor: "#111827", border: "1px solid #bfff00", boxShadow: "0 0 12px rgba(191, 255, 0, 0.15)", }} > <NavLink className="sidebar-link text-decoration-none fw-semibold" style={{ color: "#bfff00" }} to="admin-setting" onClick={() => setMenu(false)} > Settings </NavLink> </li>
